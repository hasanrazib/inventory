                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('add.supplier')}}">Add Supplier</a></li>
                                     <li><a href="{{route('view.suppliers')}}">View All Suppliers</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('add.customer')}}">Add Customer</a></li>
                                     <li><a href="{{route('view.customers')}}">View All Customers</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('add.unit')}}">Add Unit</a></li>
                                     <li><a href="{{route('view.units')}}">View All Units</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{route('add.category')}}">Add Category</a></li>
                                     <li><a href="{{route('view.categories')}}">View All Categories</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);" class="has-arrow waves-effect">
